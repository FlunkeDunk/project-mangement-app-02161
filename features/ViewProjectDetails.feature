Feature: View Project details
  ...
  #   When the user views the details of the project
  #   Then "none" is shown for the field "project_name"
  ...
  # Projektbeskrivelse siger at 30 er et typisk antal aktiviteter for et projekt. Vi tester lidt flere
  # Scenario: View the project activities with 43 activities
  #   Given a project exists
  #   And the project has activities with the names
  #     | Invade Mordor                        |
  #     | Defend Gondor                        |
